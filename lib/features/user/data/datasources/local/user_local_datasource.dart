...
import 'package:tiffinmate/features/user/data/datasources/remote/user_datasource.dart';
...
class BatchLocalDatasource implements IBatchDatasource {
  ...
  @override
  Future<bool> createBatch(UserHiveModel batch) async {
    try {
  ...
  @override
  Future<List<UserHiveModel>> getAllBatches() async {
    try {
  ...
  @override
  Future<UserHiveModel?> getBatchById(String batchId) async {
    try {
  ...
  @override
  Future<bool> updateBatch(UserHiveModel batch) async {
    try {
